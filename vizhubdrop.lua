...
-- Затемняющий градиент (атмосфера)
...
-- Небольшая пауза, чтобы юзер увидел 100%
task.wait(0.6)
...
Menu.Registry = {}  -- [sectionName][elementName] = { Type=, Get=, Set= }

-- Регистрация элемента для системы конфигов
...
-- Первичное обновление списка после загрузки
task.spawn(function()
    task.wait(1)
    refreshConfigList()
end)