...
local KEY_CONFIG = {
    -- Заголовок окна
    Title       = "VizHub - Key System",
    Subtitle    = "Введите ключ для доступа",

    -- Ссылка на твой скрипт (после успешного ключа)
    ScriptURL   = "https://raw.githubusercontent.com/Viz23-hubs/VizHub-Internal-Script/refs/heads/main/vizhubdrop.lua?token=GHSAT0AAAAAAEJO6LMFGWKVM3M3JYQWU4322VQG4TA",
